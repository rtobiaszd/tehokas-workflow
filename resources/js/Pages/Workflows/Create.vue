    ...
    JSON.stringify(
        {
            ...
            actions: workflowStore.actions.length
                ...
                : [
                      {
                          type: 'send_email',
                          to: ['manager', 'stakeholders'],
                          subject: 'Project Delayed',
                          body: 'The project {{project_name}} is delayed.',
                      },
                  ],
        },
        null,
            ...
            >
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <h2 class="mt-2 text-2xl font-semibold text-[var(--color-text)]">Create automation</h2>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <p class="text-xs text-[var(--color-muted)]">Payload will be sent as JSON.</p>
                </div>
            </form>
            ...
            <aside class="space-y-4 rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-sm">
                <div>
                    ...
                    <p class="mt-2 text-sm text-[var(--color-text)]">
                        This is the structure sent to the API.
                    </p>
                </div>
